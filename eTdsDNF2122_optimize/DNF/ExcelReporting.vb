...
Module ExcelReporting
    Public hsShortDeductions As New Hashtable
    Public hsLatePayments As New Hashtable
    Public hsShortDeposits As New Hashtable
    Public htReason As New Hashtable
    Public strProcessID As String
    Public aryExcel As New ArrayList
    Public arrData(,) As Object
    ...
    Public Sub CreateExcelFile()
        ...
        Try
            ...
            If blnDemoVersion = False Then
                ...
                If lline > 0 Then
                    If Not Directory.Exists(Forms.Application.StartupPath & "\" & TANDeductor & "_DNF") Then
                        Directory.CreateDirectory(Forms.Application.StartupPath & "\" & TANDeductor & "_DNF")
                    End If
                    filename = Forms.Application.StartupPath & "\" & TANDeductor & "_DNF\" & TANDeductor &
                            "_" & dtBH.Rows(0)(4) & "_" & dtBH.Rows(0)(17) & "_" & dtBH.Rows(0)(16) & "_" & Today.Day & Today.Month & Today.Year & "_" & dtCD.Rows(0)(3) & ".xls"
                Else
